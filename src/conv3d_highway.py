...
class Conv3DHighway(_Conv):
    def __init__(self, filters,
                 ...
                 **kwargs):
        super(Conv3DHighway, self).__init__(
            rank=3,
            filters=filters,
    ...
    def get_config(self):
        config = super(Conv3DHighway, self).get_config()
        config.pop('rank')
        return config

    def build(self, input_shape):

        super(Conv3DHighway, self).build(input_shape)
    ...
    def get_output_shape_for(self, input_shape):
        super(Conv3DHighway, self).get_output_shape_for(input_shape)
